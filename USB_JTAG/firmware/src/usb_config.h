...
#define USB_MAX_EP_NUMBER	2 //1   //Set this number to match the maximum endpoint number used in the descriptors for this firmware project
...
//Set this number to match the total number of string descriptors that are implemented in the usb_descriptors.c file
#define USB_NUM_STRING_DESCRIPTORS 4 //3 ; Serial number string descriptor should be enabled in Linux Driver.
